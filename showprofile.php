...
<?php
	//Geting values of user profile to be shown in profile page
	if(isset($_SESSION["loginUserID"])) {
		...
		if (mysqli_connect_error()) {
			...
			$SELECT = "SELECT role, fullname, email, address, phone, driverlicense From user Where userid = ? Limit 1";
			//prepare statement
			...
			$rnum = $stmt->num_rows;
			if ($rnum > 0) {
				$stmt->bind_result($role, $fullname, $email, $address, $phone, $driverlicense);
				$stmt->fetch();
			}
			$stmt->close();
		}
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Show Profile</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="menu<?php echo strtolower($role); ?>.php"><?php echo $role; ?> Menu <i class="ion-ios-arrow-forward"></i></a></span> <span>Show Profile <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
...
?>											  
				  <div class="col-md-12">
	                <div class="form-group">
	                  <a href="editprofile.php" class="btn btn-primary p-3 px-xl-4 py-xl-3">Edit Profile</a>
					  <a href="showprofile.php" class="btn btn-primary p-3 px-xl-4 py-xl-3">&nbsp;&nbsp;&nbsp;&nbsp;Back&nbsp;&nbsp;&nbsp;&nbsp;</a>
	                </div>
	              </div>
			</div>
          </div>
