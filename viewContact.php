        ...
        <div class="container">
            <div class="row d-flex align-items-stretch no-gutters">
                <div class="col-md-6 p-5 order-md-last">
                    <h2 class="h4 mb-5 font-weight-bold">Submitted Contact Information</h2>
                        <?php
                        // to connect mysql
                        $conn = mysqli_connect("localhost", "root", "", "ksk");
                        ...
                        if ($results->num_rows > 0) {
                            ...
                            while ($row = $results->fetch_assoc()) {
                                echo "<tr><td>"
                                    ...
                                    . $row["Name"] . "</td><td><br>"
                                    . $row["Email"] . "</td><td><br>"
                                    . $row["Subject"] . "</td><td><br>"
                                    . $row["Message"] . "</td><tr><br><br>";
                            }
                            echo "</table>";
                        } else {
                            echo "No appliation submitted!";
                        }
                        $conn->close();
                        ?>
                </div>
