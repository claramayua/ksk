...
<?php
	...
	if (mysqli_connect_error()) {
		...
		$SELECT = 'SELECT familyid, fullname, address, phone, latitude, longitude, '.$distanceSelect.' activeflag FROM family '.$condition.' ORDER BY familyid DESC LIMIT '.$limit.'';
...
?>
					<tr>
						...
						<td align="center">
							<a href="detailfamily.php?detailId=<?php echo $familyid_array[$i];?>" class="text-primary"><i class="fa fa-fw fa-search"></i>Detail </a>
