...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a href="viewContact.php" class="nav-link">Contact</a></li>
            ...
            <div class="container">
                <div class="row slider-text js-fullheight justify-content-center align-items-center" data-scrollax-parent="true">
                    ...
                    <div class="col-md-12 col-sm-12 text-center ftco-animate">
                        ...
                        <p><a href="#about" class="btn btn-primary p-3 px-xl-4 py-xl-3">Tell Me More</a></p>
                    </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-sm-10 wrap-about ftco-animate text-center">
                    ...
                    <p>Kechara Soup Kitchen (KSK) is a non-religious community action group that distributes food, basic medical aid and counselling to the homeless and urban poor of Malaysia. Founded by His Eminence Tsem Rinpoche, the Spiritual Guide of the Kechara organization, KSK is strictly non-religious, being mindful and respectful of others’ beliefs. KSK do not discriminate in terms of race, gender or culture. Its motto is “Hunger Knows No Barriers”. For this reason, its food is vegetarian.</p>

                    <p>Kechara Soup Kitchen (KSK) works towards the mission of ending hunger and reducing poverty. KSK began as a small Non-Governmental Organization that provided warm and nutritious vegetarian meals to the homeless. KSK has also developed food bank initiatives that collects surplus provisions from grocers and manufacturers which will be rechannelled to needy families. KSK currently collects up to 60 tons of surplus food every month.</p>

                    <div class="video justify-content-center">
                        <a href="https://www.youtube.com/watch?v=Wz6uTfzFW-E" class="icon-video popup-vimeo d-flex justify-content-center align-items-center">
    ...
    <section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(images/background_4.jpg);" data-stellar-background-ratio="0.5">
        ...
        <div class="container">
            <div class="row justify-content-center mb-5 pb-2">
                <div class="col-md-7 text-center heading-section ftco-animate">
                    ...
                    <h2 class="mb-4">KSK's Services</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4 d-flex align-self-stretch ftco-animate text-center">
                    <div class="media block-6 services d-block">
                        ...
                        <div class="media-body p-2 mt-3">
                            <h3 class="heading">Food Distribution</h3>
                            <p>On average, 1800 packs of vegetarian food consisting of biscuits, snacks, drinking water, fruits and hot food are distributed to the homeless each week.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 d-flex align-self-stretch ftco-animate text-center">
                    <div class="media block-6 services d-block">
                        ...
                        <div class="media-body p-2 mt-3">
                            <h3 class="heading">Soup Kitchen Building</h3>
                            <p>At our permanent Soup Kitchen building, we will distribute hot meals on a daily basis, provide medical treatment facilities and laundry services for the homeless.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 d-flex align-self-stretch ftco-animate text-center">
                    <div class="media block-6 services d-block">
                        ...
                        <div class="media-body p-2 mt-3">
                            <h3 class="heading">Food Bank</h3>
                            <p>Kechara Food Bank was launched with the initiative to start the Food Bank was from the regular items being dropped off at our doorstep by anonymous donors.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="staff">
                        ...
                        <div class="text pt-4">
                            <h3>Henry Ooi Seong Huat</h3>
                            <span class="position mb-2">President</span>
                            <p>I was in the skincare business for more than 15 years before I joined Kechara to manage its retail stores. I am now heading the Kechara Forest Retreat, a 35 acre land located in Bentong, Pahang.</p>
                            <div class="faded">
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="staff">
                        ...
                        <div class="text pt-4">
                            ...
                            <p>I am a single mother of two teenagers and a successful professional Gemologist. I’m always thinking of ways to enrich my life, things that can benefit both my two growing children as well as others.</p>
                            <div class="faded">
                                <!-- <p>I am an ambitious workaholic, but apart from that, pretty simple person.</p> -->
                                <ul class="ftco-social d-flex">
                                    <li class="ftco-animate"><a href="#"><span class="icon-twitter"></span></a></li>
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="staff">
                        ...
                        <div class="text pt-4">
                            ...
                            <p>I have known H.E. the 25th Tsem Rinpoche since 1992 and through encouragement, I started to volunteer at Kechara Soup Kitchen in 2007 when we were operating from the streets of Bukit Bintang.</p>
                            <div class="faded">
                                <!-- <p>I am an ambitious workaholic, but apart from that, pretty simple person.</p> -->
                                <ul class="ftco-social d-flex">
                                    <li class="ftco-animate"><a href="#"><span class="icon-twitter"></span></a></li>
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="staff">
                        ...
                        <div class="text pt-4">
                            ...
                            <p>A electronics engineer who started volunteering in Kechara Soup Kitchen before its official inception in 2008. I was part of an informal group who believed in the vision of Kechara’s founder.</p>
                            <div class="faded">
                                <!-- <p>I am an ambitious workaholic, but apart from that, pretty simple person.</p> -->
                                <ul class="ftco-social d-flex">
                                    <li class="ftco-animate"><a href="#"><span class="icon-twitter"></span></a></li>
